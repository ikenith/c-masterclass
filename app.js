...
const COURSE_MODULES = [
  ...
  },
  {
    ...
    "slides": "Slides 31\u201345",
    "time": "40 mins",
    "content": "\n      <div class=\"teaching-block\">\n        <h3><i class=\"fa-solid fa-cake-candles\"></i> What is an Algorithm? Think of a Recipe!</h3>\n        <p class=\"lead-text\">\n          Before you bake a cake, you need a recipe. If a recipe says <em>\"mix stuff and bake until it looks ready,\"</em> that's a terrible recipe because it is vague and ambiguous. But if it says:\n          <br>&emsp;<code>1. Take 2 eggs and 1 cup of flour</code>\n          <br>&emsp;<code>2. Whisk for 3 minutes until smooth</code>\n          <br>&emsp;<code>3. Bake at 350&deg;F for exactly 25 minutes</code>\n          <br>Anyone following that recipe will produce the exact same delicious cake! In computer science, an <strong>Algorithm</strong> is precisely that: a finite, unambiguous, step-by-step procedure to solve a specific problem.\n        </p>\n\n        <div class=\"teacher-callout insight\">\n          <div class=\"callout-icon\"><i class=\"fa-solid fa-lightbulb\"></i></div>\n          <div class=\"callout-body\">\n            <div class=\"callout-title\">The 4 Non-Negotiable Rules of Every Valid Algorithm (Slide 31)</div>\n            <p>&bull; <strong>Clear &amp; Unambiguous:</strong> Every single instruction must have only one possible interpretation.<br>\n            &bull; <strong>Well-Defined Inputs &amp; Outputs:</strong> Accepts zero or more defined inputs and guarantees one or more defined outputs.<br>\n            &bull; <strong>Finiteness (Must Terminate!):</strong> Must stop executing after a countable, finite number of steps. An infinite loop is never an algorithm!<br>\n            &bull; <strong>Language-Independent:</strong> Stated in pure mathematical and logical terms so it can be implemented in C, Python, Java, or Rust alike.</p>\n          </div>\n        </div>\n      </div>\n\n      <div class=\"teaching-block\">\n        <h3><i class=\"fa-solid fa-bridge\"></i> Pseudocode: The Rosetta Stone Between Thought and C</h3>\n        <p>Trying to design algorithm logic while simultaneously worrying about semicolons, curly braces, and compiler errors causes cognitive overload. <strong>Pseudocode</strong> bridges this gap&mdash;it is structured English that mirrors high-level code structure without strict syntax penalties.</p>\n\n        <div class=\"rosetta-bridge\">\n          <div class=\"rosetta-col\">\n            <div class=\"rosetta-header english\"><i class=\"fa-solid fa-user\"></i> 1. Human Thought</div>\n            <div class=\"rosetta-body\">\n              \"Ask the user for four exam marks. Find their average. If the average is below 40, they failed; otherwise they passed.\"\n            </div>\n          </div>\n\n          <div class=\"rosetta-col\">\n            <div class=\"rosetta-header pseudocode\"><i class=\"fa-solid fa-file-lines\"></i> 2. Clean Pseudocode</div>\n            <div class=\"rosetta-body\">\n              <pre>READ m1, m2, m3, m4\navg = (m1 + m2 + m3 + m4) / 4\n\nIF avg &lt; 40 THEN\n    PRINT \"Fail\"\nELSE\n    PRINT \"Pass\"\nENDIF</pre>\n            </div>\n          </div>\n\n          <div class=\"rosetta-col\">\n            <div class=\"rosetta-header c-code\"><i class=\"fa-solid fa-code\"></i> 3. Actual C Language</div>\n            <div class=\"rosetta-body\">\n              <pre>float m1, m2, m3, m4, avg;\nscanf(\"%f %f %f %f\", &amp;m1, &amp;m2, &amp;m3, &amp;m4);\navg = (m1 + m2 + m3 + m4) / 4.0;\n\nif (avg &lt; 40) {\n    printf(\"Fail\\n\");\n} else {\n    printf(\"Pass\\n\");\n}</pre>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <div class=\"teaching-block\">\n        <h3><i class=\"fa-solid fa-shapes\"></i> Standard ISO Flowchart Shapes: Geometric Reference Guide</h3>\n        <p class=\"lead-text\">\n          A <strong>Flowchart</strong> is a formalized diagrammatic representation of an algorithm using standardized geometric symbols (ISO 5807). Each shape has an unambiguous mathematical role:\n        </p>\n\n        <div class=\"shape-ref-grid\">\n          <!-- 1. Terminal -->\n          <div class=\"shape-ref-card\">\n            <div class=\"shape-ref-svg-wrap\">\n              <svg viewBox=\"0 0 200 80\" width=\"180\" height=\"72\">\n                <rect x=\"15\" y=\"15\" width=\"170\" height=\"50\" rx=\"25\" ry=\"25\" fill=\"#0f291e\" stroke=\"#10b981\" stroke-width=\"2.5\"/>\n                <text x=\"100\" y=\"44\" class=\"svg-node-text\" fill=\"#10b981\">START / STOP</text>\n              </svg>\n            </div>\n            <div class=\"shape-ref-title\">Terminal Symbol</div>\n            <div class=\"shape-ref-role\">Oval / Stadium / Capsule</div>\n            <div class=\"shape-ref-desc\">Marks the absolute entry point (START) or exit point (STOP / END) of the program. Every flowchart must have at least one.</div>\n            <div class=\"shape-ref-meta\">\n              <div><strong>Real Example:</strong> <code>START</code> or <code>STOP</code></div>\n              <div><strong>C Equivalent:</strong> <code>int main(void) { ... return 0; }</code></div>\n            </div>\n          </div>\n\n          <!-- 2. Input / Output -->\n          <div class=\"shape-ref-card\">\n            <div class=\"shape-ref-svg-wrap\">\n              <svg viewBox=\"0 0 200 80\" width=\"180\" height=\"72\">\n                <polygon points=\"40,15 190,15 155,65 5,65\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2.5\"/>\n                <text x=\"98\" y=\"44\" class=\"svg-node-text\" fill=\"#93c5fd\">INPUT / OUTPUT</text>\n              </svg>\n            </div>\n            <div class=\"shape-ref-title\">Input / Output Symbol</div>\n            <div class=\"shape-ref-role\">True Angled Parallelogram</div>\n            <div class=\"shape-ref-desc\">Used whenever the program receives external data from the user/keyboard (READ) or presents answers on the screen (PRINT / DISPLAY).</div>\n            <div class=\"shape-ref-meta\">\n              <div><strong>Real Example:</strong> <code>READ Radius</code> / <code>PRINT Area</code></div>\n              <div><strong>C Equivalent:</strong> <code>scanf(\"%f\", &amp;r);</code> / <code>printf(...)</code></div>\n            </div>\n          </div>\n\n          <!-- 3. Process -->\n          <div class=\"shape-ref-card\">\n            <div class=\"shape-ref-svg-wrap\">\n              <svg viewBox=\"0 0 200 80\" width=\"180\" height=\"72\">\n                <rect x=\"15\" y=\"15\" width=\"170\" height=\"50\" rx=\"3\" ry=\"3\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2.5\"/>\n                <text x=\"100\" y=\"44\" class=\"svg-node-text\" fill=\"#fcd34d\">PROCESS (Computation)</text>\n              </svg>\n            </div>\n            <div class=\"shape-ref-title\">Process Symbol</div>\n            <div class=\"shape-ref-role\">Sharp 90&deg; Rectangle</div>\n            <div class=\"shape-ref-desc\">Represents arithmetic operations, data manipulation, or variable assignments. Has exactly one incoming flowline and one outgoing flowline.</div>\n            <div class=\"shape-ref-meta\">\n              <div><strong>Real Example:</strong> <code>Area = PI * r * r</code> / <code>count = 0</code></div>\n              <div><strong>C Equivalent:</strong> <code>float area = 3.14159f * r * r;</code></div>\n            </div>\n          </div>\n\n          <!-- 4. Decision -->\n          <div class=\"shape-ref-card\">\n            <div class=\"shape-ref-svg-wrap\">\n              <svg viewBox=\"0 0 200 80\" width=\"180\" height=\"72\">\n                <polygon points=\"100,10 188,40 100,70 12,40\" fill=\"#2e1065\" stroke=\"#a855f7\" stroke-width=\"2.5\"/>\n                <text x=\"100\" y=\"44\" class=\"svg-node-text\" fill=\"#d8b4fe\">DECISION (Test?)</text>\n              </svg>\n            </div>\n            <div class=\"shape-ref-title\">Decision Symbol</div>\n            <div class=\"shape-ref-role\">True 4-Point Rhombus / Diamond</div>\n            <div class=\"shape-ref-desc\">Evaluates a boolean conditional test. Must have one incoming flowline and <strong>two distinct outgoing branch flowlines</strong> clearly labeled.</div>\n            <div class=\"shape-ref-meta\">\n              <div><strong>Real Example:</strong> <code>Is Age &gt;= 18?</code> / <code>Is N == 0?</code></div>\n              <div><strong>C Equivalent:</strong> <code>if (age &gt;= 18) { ... } else { ... }</code></div>\n            </div>\n          </div>\n\n          <!-- 5. Connector -->\n          <div class=\"shape-ref-card\">\n            <div class=\"shape-ref-svg-wrap\">\n              <svg viewBox=\"0 0 200 80\" width=\"180\" height=\"72\">\n                <circle cx=\"100\" cy=\"40\" r=\"28\" fill=\"#18181b\" stroke=\"#71717a\" stroke-width=\"2.5\"/>\n                <text x=\"100\" y=\"45\" class=\"svg-node-text\" fill=\"#ffffff\" font-size=\"14\">A</text>\n              </svg>\n            </div>\n            <div class=\"shape-ref-title\">On-Page Connector</div>\n            <div class=\"shape-ref-role\">Exact Circle</div>\n            <div class=\"shape-ref-desc\">Connects converging or distant flowlines on the same page to prevent messy, crisscrossing lines. Contains an identifier letter or number.</div>\n            <div class=\"shape-ref-meta\">\n              <div><strong>Real Example:</strong> Convergence junction labeled <code>1</code> or <code>A</code></div>\n              <div><strong>C Equivalent:</strong> Common junction after an <code>if-else</code> block</div>\n            </div>\n          </div>\n\n          <!-- 6. Predefined Process / Subroutine -->\n          <div class=\"shape-ref-card\">\n            <div class=\"shape-ref-svg-wrap\">\n              <svg viewBox=\"0 0 200 80\" width=\"180\" height=\"72\">\n                <rect x=\"15\" y=\"15\" width=\"170\" height=\"50\" rx=\"3\" ry=\"3\" fill=\"#082f49\" stroke=\"#06b6d4\" stroke-width=\"2.5\"/>\n                <line x1=\"38\" y1=\"15\" x2=\"38\" y2=\"65\" stroke=\"#06b6d4\" stroke-width=\"2\"/>\n                <line x1=\"162\" y1=\"15\" x2=\"162\" y2=\"65\" stroke=\"#06b6d4\" stroke-width=\"2\"/>\n                <text x=\"100\" y=\"44\" class=\"svg-node-text\" fill=\"#67e8f9\">SUBROUTINE()</text>\n              </svg>\n            </div>\n            <div class=\"shape-ref-title\">Predefined Process</div>\n            <div class=\"shape-ref-role\">Rectangle with Double Vertical Bars</div>\n            <div class=\"shape-ref-desc\">Specifies a call to a separate, modular subroutine or library routine whose detailed flowchart is documented elsewhere.</div>\n            <div class=\"shape-ref-meta\">\n              <div><strong>Real Example:</strong> <code>ComputeRoots(a, b, c)</code></div>\n              <div><strong>C Equivalent:</strong> Calling a function: <code>double r = sqrt(d);</code></div>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <!-- ================================================================== -->\n      <!-- EXAMPLE 1: SEQUENTIAL LOGIC -->\n      <!-- ================================================================== -->\n      <div class=\"flowchart-showcase\">\n        <div class=\"flowchart-showcase-header\">\n          <div>\n            <h4><i class=\"fa-solid fa-arrow-down-long\"></i> Flowchart Example 1: Pure Sequential Execution</h4>\n            <p style=\"color: var(--text-muted); font-size: 0.85rem; margin-top: 0.25rem;\">Problem: Calculate the Area and Perimeter of a Rectangle given Length and Width.</p>\n          </div>\n          <div class=\"flowchart-badge-group\">\n            <span class=\"fc-type-badge seq\">Sequential Flow</span>\n            <span class=\"fc-type-badge\">Linear Execution</span>\n          </div>\n        </div>\n\n        <p>In a <strong>Sequential Flowchart</strong>, every instruction executes one after the other in strict linear order from top to bottom with zero branching and zero loops.</p>\n\n        <!-- SVG Flowchart 1 -->\n        <div class=\"flowchart-svg-card\">\n          <svg viewBox=\"0 0 380 470\" width=\"360\" height=\"450\">\n            <defs>\n              <marker id=\"fc1-arr\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#a1a1aa\" />\n              </marker>\n            </defs>\n\n            <!-- START -->\n            <rect x=\"110\" y=\"15\" width=\"160\" height=\"42\" rx=\"21\" fill=\"#0f291e\" stroke=\"#10b981\" stroke-width=\"2\"/>\n            <text x=\"190\" y=\"38\" class=\"svg-node-text\" fill=\"#10b981\">START</text>\n\n            <!-- Arrow 1 -->\n            <line x1=\"190\" y1=\"57\" x2=\"190\" y2=\"88\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc1-arr)\"/>\n\n            <!-- READ L, W -->\n            <polygon points=\"105,90 285,90 255,135 75,135\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"180\" y=\"115\" class=\"svg-node-text\" fill=\"#93c5fd\">READ Length, Width</text>\n\n            <!-- Arrow 2 -->\n            <line x1=\"180\" y1=\"135\" x2=\"180\" y2=\"168\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc1-arr)\"/>\n\n            <!-- Area Calc -->\n            <rect x=\"80\" y=\"170\" width=\"200\" height=\"44\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"180\" y=\"195\" class=\"svg-node-text\" fill=\"#fcd34d\">Area = Length * Width</text>\n\n            <!-- Arrow 3 -->\n            <line x1=\"180\" y1=\"214\" x2=\"180\" y2=\"248\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc1-arr)\"/>\n\n            <!-- Perimeter Calc -->\n            <rect x=\"70\" y=\"250\" width=\"220\" height=\"44\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"180\" y=\"275\" class=\"svg-node-text\" fill=\"#fcd34d\">Perimeter = 2 * (L + W)</text>\n\n            <!-- Arrow 4 -->\n            <line x1=\"180\" y1=\"294\" x2=\"180\" y2=\"328\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc1-arr)\"/>\n\n            <!-- PRINT -->\n            <polygon points=\"85,330 295,330 265,375 55,375\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"175\" y=\"355\" class=\"svg-node-text\" fill=\"#93c5fd\">PRINT Area, Perimeter</text>\n\n            <!-- Arrow 5 -->\n            <line x1=\"175\" y1=\"375\" x2=\"175\" y2=\"408\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc1-arr)\"/>\n\n            <!-- STOP -->\n            <rect x=\"95\" y=\"410\" width=\"160\" height=\"42\" rx=\"21\" fill=\"#2b0e14\" stroke=\"#f43f5e\" stroke-width=\"2\"/>\n            <text x=\"175\" y=\"433\" class=\"svg-node-text\" fill=\"#fca5a5\">STOP (END)</text>\n          </svg>\n        </div>\n\n        <div class=\"trace-table-wrap\">\n          <h5>Execution Trace Table for Example 1</h5>\n          <table class=\"trace-table\">\n            <thead>\n              <tr><th>Step #</th><th>Flowchart Action</th><th>Length (L)</th><th>Width (W)</th><th>Area</th><th>Perimeter</th><th>Screen Output</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>1</td><td>START</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td></tr>\n              <tr><td>2</td><td>READ Length, Width</td><td><strong>10.0</strong></td><td><strong>5.0</strong></td><td>-</td><td>-</td><td>-</td></tr>\n              <tr><td>3</td><td>Area = L * W</td><td>10.0</td><td>5.0</td><td><strong>50.0</strong></td><td>-</td><td>-</td></tr>\n              <tr><td>4</td><td>Perimeter = 2 * (L + W)</td><td>10.0</td><td>5.0</td><td>50.0</td><td><strong>30.0</strong></td><td>-</td></tr>\n              <tr class=\"highlight-row\"><td>5</td><td>PRINT Area, Perimeter</td><td>10.0</td><td>5.0</td><td>50.0</td><td>30.0</td><td><code>Area = 50.00, Perimeter = 30.00</code></td></tr>\n              <tr><td>6</td><td>STOP</td><td>10.0</td><td>5.0</td><td>50.0</td><td>30.0</td><td>Program terminates cleanly</td></tr>\n            </tbody>\n          </table>\n        </div>\n      </div>\n\n      <!-- ================================================================== -->\n      <!-- EXAMPLE 2: SELECTION / TWO-WAY DECISION -->\n      <!-- ================================================================== -->\n      <div class=\"flowchart-showcase\">\n        <div class=\"flowchart-showcase-header\">\n          <div>\n            <h4><i class=\"fa-solid fa-code-branch\"></i> Flowchart Example 2: Two-Way Selection Decision</h4>\n            <p style=\"color: var(--text-muted); font-size: 0.85rem; margin-top: 0.25rem;\">Problem: Read two numbers A and B, determine and print the largest number.</p>\n          </div>\n          <div class=\"flowchart-badge-group\">\n            <span class=\"fc-type-badge branch\">Selection Logic</span>\n            <span class=\"fc-type-badge\">True Diamond</span>\n          </div>\n        </div>\n\n        <p>In a <strong>Selection Flowchart</strong>, the control encounters a conditional test inside a <strong>Decision Diamond</strong>. Control branches into two mutually exclusive paths (TRUE vs FALSE) that subsequently reunite at a connector.</p>\n\n        <!-- SVG Flowchart 2 -->\n        <div class=\"flowchart-svg-card\">\n          <svg viewBox=\"0 0 560 480\" width=\"540\" height=\"460\">\n            <defs>\n              <marker id=\"fc2-arr\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#a1a1aa\" />\n              </marker>\n              <marker id=\"fc2-arr-green\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#10b981\" />\n              </marker>\n              <marker id=\"fc2-arr-red\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#f43f5e\" />\n              </marker>\n            </defs>\n\n            <!-- START -->\n            <rect x=\"200\" y=\"15\" width=\"160\" height=\"40\" rx=\"20\" fill=\"#0f291e\" stroke=\"#10b981\" stroke-width=\"2\"/>\n            <text x=\"280\" y=\"37\" class=\"svg-node-text\" fill=\"#10b981\">START</text>\n\n            <!-- Arrow 1 -->\n            <line x1=\"280\" y1=\"55\" x2=\"280\" y2=\"85\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc2-arr)\"/>\n\n            <!-- READ A, B -->\n            <polygon points=\"215,85 365,85 335,130 185,130\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"275\" y=\"110\" class=\"svg-node-text\" fill=\"#93c5fd\">READ A, B</text>\n\n            <!-- Arrow 2 -->\n            <line x1=\"275\" y1=\"130\" x2=\"275\" y2=\"160\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc2-arr)\"/>\n\n            <!-- DECISION DIAMOND -->\n            <polygon points=\"275,160 380,205 275,250 170,205\" fill=\"#2e1065\" stroke=\"#a855f7\" stroke-width=\"2.5\"/>\n            <text x=\"275\" y=\"208\" class=\"svg-node-text\" fill=\"#e9d5ff\">Is A &gt; B?</text>\n\n            <!-- Left Branch: TRUE (A > B) -->\n            <path d=\"M 170 205 L 100 205 L 100 245\" stroke=\"#10b981\" stroke-width=\"2\" marker-end=\"url(#fc2-arr-green)\"/>\n            <text x=\"120\" y=\"195\" class=\"svg-label-text true\">YES (True)</text>\n\n            <!-- Left Action: PRINT A is Largest -->\n            <polygon points=\"35,248 185,248 160,292 10,292\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"97\" y=\"272\" class=\"svg-node-text\" fill=\"#93c5fd\" font-size=\"12\">PRINT \"A is Largest\"</text>\n\n            <!-- Right Branch: FALSE (A <= B) -->\n            <path d=\"M 380 205 L 450 205 L 450 245\" stroke=\"#f43f5e\" stroke-width=\"2\" marker-end=\"url(#fc2-arr-red)\"/>\n            <text x=\"390\" y=\"195\" class=\"svg-label-text false\">NO (False)</text>\n\n            <!-- Right Action: PRINT B is Largest -->\n            <polygon points=\"385,248 535,248 510,292 360,292\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"447\" y=\"272\" class=\"svg-node-text\" fill=\"#93c5fd\" font-size=\"12\">PRINT \"B is Largest\"</text>\n\n            <!-- Convergence lines into Connector -->\n            <path d=\"M 97 292 L 97 340 L 255 340\" stroke=\"#a1a1aa\" stroke-width=\"2\"/>\n            <path d=\"M 447 292 L 447 340 L 295 340\" stroke=\"#a1a1aa\" stroke-width=\"2\"/>\n\n            <!-- Connector Circle 1 -->\n            <circle cx=\"275\" cy=\"340\" r=\"16\" fill=\"#18181b\" stroke=\"#71717a\" stroke-width=\"2\"/>\n            <text x=\"275\" y=\"344\" class=\"svg-node-text\" fill=\"#ffffff\" font-size=\"12\">1</text>\n\n            <!-- Arrow from Connector to STOP -->\n            <line x1=\"275\" y1=\"356\" x2=\"275\" y2=\"390\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc2-arr)\"/>\n\n            <!-- STOP -->\n            <rect x=\"195\" y=\"392\" width=\"160\" height=\"40\" rx=\"20\" fill=\"#2b0e14\" stroke=\"#f43f5e\" stroke-width=\"2\"/>\n            <text x=\"275\" y=\"414\" class=\"svg-node-text\" fill=\"#fca5a5\">STOP (END)</text>\n          </svg>\n        </div>\n\n        <div class=\"trace-table-wrap\">\n          <h5>Execution Trace Table for Example 2 (Testing Both Branches)</h5>\n          <table class=\"trace-table\">\n            <thead>\n              <tr><th>Test Case</th><th>Input A</th><th>Input B</th><th>Decision Test (A &gt; B)</th><th>Branch Taken</th><th>Screen Output</th></tr>\n            </thead>\n            <tbody>\n              <tr><td><strong>Case 1</strong></td><td>25</td><td>14</td><td><code>25 &gt; 14</code> evaluates to <strong>TRUE</strong></td><td>YES branch (Left)</td><td><code>A is Largest (25)</code></td></tr>\n              <tr class=\"highlight-row\"><td><strong>Case 2</strong></td><td>7</td><td>19</td><td><code>7 &gt; 19</code> evaluates to <strong>FALSE</strong></td><td>NO branch (Right)</td><td><code>B is Largest (19)</code></td></tr>\n              <tr><td><strong>Case 3 (Equal)</strong></td><td>12</td><td>12</td><td><code>12 &gt; 12</code> evaluates to <strong>FALSE</strong></td><td>NO branch (Right)</td><td><code>B is Largest (12)</code></td></tr>\n            </tbody>\n          </table>\n        </div>\n      </div>\n\n      <!-- ================================================================== -->\n      <!-- EXAMPLE 3: MULTI-WAY / NESTED DECISION -->\n      <!-- ================================================================== -->\n      <div class=\"flowchart-showcase\">\n        <div class=\"flowchart-showcase-header\">\n          <div>\n            <h4><i class=\"fa-solid fa-sitemap\"></i> Flowchart Example 3: Multi-Way Nested Selection (If-Else-If)</h4>\n            <p style=\"color: var(--text-muted); font-size: 0.85rem; margin-top: 0.25rem;\">Problem: Check if a number N is Positive, Negative, or Zero.</p>\n          </div>\n          <div class=\"flowchart-badge-group\">\n            <span class=\"fc-type-badge branch\">Cascading Diamonds</span>\n            <span class=\"fc-type-badge\">3-Way Junction</span>\n          </div>\n        </div>\n\n        <p>When an algorithm requires choosing among more than two outcomes, decision diamonds are <strong>nested</strong> or cascaded in sequence:</p>\n\n        <!-- SVG Flowchart 3 -->\n        <div class=\"flowchart-svg-card\">\n          <svg viewBox=\"0 0 600 520\" width=\"580\" height=\"500\">\n            <defs>\n              <marker id=\"fc3-arr\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#a1a1aa\" />\n              </marker>\n              <marker id=\"fc3-arr-green\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#10b981\" />\n              </marker>\n              <marker id=\"fc3-arr-red\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#f43f5e\" />\n              </marker>\n            </defs>\n\n            <!-- START -->\n            <rect x=\"220\" y=\"15\" width=\"160\" height=\"38\" rx=\"19\" fill=\"#0f291e\" stroke=\"#10b981\" stroke-width=\"2\"/>\n            <text x=\"300\" y=\"36\" class=\"svg-node-text\" fill=\"#10b981\">START</text>\n\n            <!-- Arrow to READ -->\n            <line x1=\"300\" y1=\"53\" x2=\"300\" y2=\"80\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc3-arr)\"/>\n\n            <!-- READ N -->\n            <polygon points=\"235,80 385,80 355,120 205,120\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"295\" y=\"103\" class=\"svg-node-text\" fill=\"#93c5fd\">READ N</text>\n\n            <!-- Arrow to Diamond 1 -->\n            <line x1=\"295\" y1=\"120\" x2=\"295\" y2=\"150\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc3-arr)\"/>\n\n            <!-- DIAMOND 1: Is N > 0? -->\n            <polygon points=\"295,150 395,190 295,230 195,190\" fill=\"#2e1065\" stroke=\"#a855f7\" stroke-width=\"2\"/>\n            <text x=\"295\" y=\"193\" class=\"svg-node-text\" fill=\"#e9d5ff\">Is N &gt; 0?</text>\n\n            <!-- D1 YES: PRINT Positive (Left) -->\n            <path d=\"M 195 190 L 120 190 L 120 220\" stroke=\"#10b981\" stroke-width=\"2\" marker-end=\"url(#fc3-arr-green)\"/>\n            <text x=\"135\" y=\"180\" class=\"svg-label-text true\">YES</text>\n            <polygon points=\"50,222 190,222 170,260 30,260\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"110\" y=\"243\" class=\"svg-node-text\" fill=\"#93c5fd\" font-size=\"12\">PRINT \"Positive\"</text>\n\n            <!-- D1 NO: Down to Diamond 2 -->\n            <line x1=\"295\" y1=\"230\" x2=\"295\" y2=\"275\" stroke=\"#f43f5e\" stroke-width=\"2\" marker-end=\"url(#fc3-arr-red)\"/>\n            <text x=\"305\" y=\"250\" class=\"svg-label-text false\">NO</text>\n\n            <!-- DIAMOND 2: Is N < 0? -->\n            <polygon points=\"295,275 395,315 295,355 195,315\" fill=\"#2e1065\" stroke=\"#a855f7\" stroke-width=\"2\"/>\n            <text x=\"295\" y=\"318\" class=\"svg-node-text\" fill=\"#e9d5ff\">Is N &lt; 0?</text>\n\n            <!-- D2 YES: PRINT Negative (Right) -->\n            <path d=\"M 395 315 L 470 315 L 470 345\" stroke=\"#10b981\" stroke-width=\"2\" marker-end=\"url(#fc3-arr-green)\"/>\n            <text x=\"410\" y=\"305\" class=\"svg-label-text true\">YES</text>\n            <polygon points=\"405,348 545,348 525,386 385,386\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"465\" y=\"369\" class=\"svg-node-text\" fill=\"#93c5fd\" font-size=\"12\">PRINT \"Negative\"</text>\n\n            <!-- D2 NO: Down to PRINT Zero -->\n            <line x1=\"295\" y1=\"355\" x2=\"295\" y2=\"388\" stroke=\"#f43f5e\" stroke-width=\"2\" marker-end=\"url(#fc3-arr-red)\"/>\n            <text x=\"305\" y=\"370\" class=\"svg-label-text false\">NO</text>\n            <polygon points=\"230,390 370,390 350,428 210,428\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"290\" y=\"411\" class=\"svg-node-text\" fill=\"#93c5fd\" font-size=\"12\">PRINT \"Zero\"</text>\n\n            <!-- Convergence Paths -->\n            <path d=\"M 110 260 L 110 455 L 275 455\" stroke=\"#a1a1aa\" stroke-width=\"2\"/>\n            <path d=\"M 465 386 L 465 455 L 305 455\" stroke=\"#a1a1aa\" stroke-width=\"2\"/>\n            <line x1=\"290\" y1=\"428\" x2=\"290\" y2=\"455\" stroke=\"#a1a1aa\" stroke-width=\"2\"/>\n\n            <!-- STOP Terminal -->\n            <rect x=\"210\" y=\"470\" width=\"160\" height=\"38\" rx=\"19\" fill=\"#2b0e14\" stroke=\"#f43f5e\" stroke-width=\"2\"/>\n            <text x=\"290\" y=\"491\" class=\"svg-node-text\" fill=\"#fca5a5\">STOP (END)</text>\n            <line x1=\"290\" y1=\"455\" x2=\"290\" y2=\"470\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc3-arr)\"/>\n          </svg>\n        </div>\n\n        <div class=\"trace-table-wrap\">\n          <h5>Execution Trace Table for Example 3</h5>\n          <table class=\"trace-table\">\n            <thead>\n              <tr><th>Test Value N</th><th>Diamond 1: (N &gt; 0)</th><th>Diamond 2: (N &lt; 0)</th><th>Final Action</th><th>Output</th></tr>\n            </thead>\n            <tbody>\n              <tr><td><code>+42</code></td><td><strong>TRUE</strong></td><td>(Skipped)</td><td>Prints Positive &rarr; Exits to STOP</td><td><code>Positive</code></td></tr>\n              <tr class=\"highlight-row\"><td><code>-15</code></td><td>FALSE</td><td><strong>TRUE</strong></td><td>Prints Negative &rarr; Exits to STOP</td><td><code>Negative</code></td></tr>\n              <tr><td><code>0</code></td><td>FALSE</td><td>FALSE</td><td>Prints Zero &rarr; Exits to STOP</td><td><code>Zero</code></td></tr>\n            </tbody>\n          </table>\n        </div>\n      </div>\n\n      <!-- ================================================================== -->\n      <!-- EXAMPLE 4: REPETITION / LOOPING WITH LOOPBACK ARROW -->\n      <!-- ================================================================== -->\n      <div class=\"flowchart-showcase\">\n        <div class=\"flowchart-showcase-header\">\n          <div>\n            <h4><i class=\"fa-solid fa-arrows-spin\"></i> Flowchart Example 4: Iteration / Looping with Loopback Arrow</h4>\n            <p style=\"color: var(--text-muted); font-size: 0.85rem; margin-top: 0.25rem;\">Problem: Calculate the Sum of First N Natural Numbers (1 + 2 + ... + N).</p>\n          </div>\n          <div class=\"flowchart-badge-group\">\n            <span class=\"fc-type-badge loop\">Cyclic Loop</span>\n            <span class=\"fc-type-badge\">Loopback Arrow</span>\n          </div>\n        </div>\n\n        <p>In a <strong>Looping Flowchart</strong>, instructions execute repeatedly as long as a condition holds True. Notice the <strong>Loopback Flowline (cyan dashed line)</strong> which travels backward from the bottom of the loop body back to the top of the decision diamond!</p>\n\n        <!-- SVG Flowchart 4 -->\n        <div class=\"flowchart-svg-card\">\n          <svg viewBox=\"0 0 540 560\" width=\"520\" height=\"540\">\n            <defs>\n              <marker id=\"fc4-arr\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#a1a1aa\" />\n              </marker>\n              <marker id=\"fc4-arr-green\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#10b981\" />\n              </marker>\n              <marker id=\"fc4-arr-red\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#f43f5e\" />\n              </marker>\n              <marker id=\"fc4-arr-cyan\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#06b6d4\" />\n              </marker>\n            </defs>\n\n            <!-- START -->\n            <rect x=\"170\" y=\"15\" width=\"160\" height=\"38\" rx=\"19\" fill=\"#0f291e\" stroke=\"#10b981\" stroke-width=\"2\"/>\n            <text x=\"250\" y=\"36\" class=\"svg-node-text\" fill=\"#10b981\">START</text>\n\n            <!-- Arrow to READ -->\n            <line x1=\"250\" y1=\"53\" x2=\"250\" y2=\"80\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc4-arr)\"/>\n\n            <!-- READ N -->\n            <polygon points=\"185,80 335,80 305,120 155,120\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"103\" class=\"svg-node-text\" fill=\"#93c5fd\">READ N</text>\n\n            <!-- Arrow to Init -->\n            <line x1=\"245\" y1=\"120\" x2=\"245\" y2=\"148\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc4-arr)\"/>\n\n            <!-- INIT: Sum = 0, i = 1 -->\n            <rect x=\"150\" y=\"150\" width=\"190\" height=\"40\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"173\" class=\"svg-node-text\" fill=\"#fcd34d\">Sum = 0, i = 1</text>\n\n            <!-- Arrow to Loop Diamond -->\n            <line x1=\"245\" y1=\"190\" x2=\"245\" y2=\"220\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc4-arr)\"/>\n\n            <!-- LOOP DECISION DIAMOND: Is i <= N? -->\n            <polygon points=\"245,220 345,260 245,300 145,260\" fill=\"#2e1065\" stroke=\"#a855f7\" stroke-width=\"2.5\"/>\n            <text x=\"245\" y=\"263\" class=\"svg-node-text\" fill=\"#e9d5ff\">Is i &lt;= N?</text>\n\n            <!-- YES Branch (Down into loop body) -->\n            <line x1=\"245\" y1=\"300\" x2=\"245\" y2=\"335\" stroke=\"#10b981\" stroke-width=\"2\" marker-end=\"url(#fc4-arr-green)\"/>\n            <text x=\"255\" y=\"318\" class=\"svg-label-text true\">YES</text>\n\n            <!-- Loop Action 1: Sum = Sum + i -->\n            <rect x=\"150\" y=\"337\" width=\"190\" height=\"40\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"360\" class=\"svg-node-text\" fill=\"#fcd34d\">Sum = Sum + i</text>\n\n            <!-- Arrow to Increment -->\n            <line x1=\"245\" y1=\"377\" x2=\"245\" y2=\"405\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc4-arr)\"/>\n\n            <!-- Loop Action 2: i = i + 1 -->\n            <rect x=\"160\" y=\"407\" width=\"170\" height=\"40\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"430\" class=\"svg-node-text\" fill=\"#fcd34d\">i = i + 1</text>\n\n            <!-- THE LOOPBACK LINE (Cycling back up to top of Diamond) -->\n            <path d=\"M 245 447 L 245 480 L 60 480 L 60 208 L 240 208\" fill=\"none\" stroke=\"#06b6d4\" stroke-width=\"2.2\" stroke-dasharray=\"5 3\" marker-end=\"url(#fc4-arr-cyan)\"/>\n            <text x=\"70\" y=\"350\" fill=\"#06b6d4\" font-family=\"var(--font-mono)\" font-size=\"11\" font-weight=\"700\" transform=\"rotate(-90 70 350)\">Loopback: re-test condition</text>\n\n            <!-- NO Branch (Exit loop to Right) -->\n            <path d=\"M 345 260 L 440 260 L 440 330\" stroke=\"#f43f5e\" stroke-width=\"2\" marker-end=\"url(#fc4-arr-red)\"/>\n            <text x=\"360\" y=\"250\" class=\"svg-label-text false\">NO (Exit)</text>\n\n            <!-- Output Parallelogram: PRINT Sum -->\n            <polygon points=\"370,332 510,332 490,375 350,375\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"430\" y=\"356\" class=\"svg-node-text\" fill=\"#93c5fd\" font-size=\"12\">PRINT Sum</text>\n\n            <!-- Arrow to STOP -->\n            <line x1=\"430\" y1=\"375\" x2=\"430\" y2=\"415\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc4-arr)\"/>\n\n            <!-- STOP -->\n            <rect x=\"350\" y=\"417\" width=\"160\" height=\"38\" rx=\"19\" fill=\"#2b0e14\" stroke=\"#f43f5e\" stroke-width=\"2\"/>\n            <text x=\"430\" y=\"438\" class=\"svg-node-text\" fill=\"#fca5a5\">STOP (END)</text>\n          </svg>\n        </div>\n\n        <div class=\"trace-table-wrap\">\n          <h5>Step-by-Step Execution Trace Table for N = 4</h5>\n          <table class=\"trace-table\">\n            <thead>\n              <tr><th>Cycle</th><th>Loop Counter (i)</th><th>Condition (i &lt;= 4)</th><th>Current Sum</th><th>Computation (Sum + i)</th><th>New Sum</th><th>Next i (i + 1)</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>Init</td><td>1</td><td>-</td><td>0</td><td>-</td><td>0</td><td>1</td></tr>\n              <tr><td><strong>Turn 1</strong></td><td>1</td><td><code>1 &lt;= 4</code> &rarr; <strong>TRUE</strong></td><td>0</td><td>0 + 1</td><td><strong>1</strong></td><td>2</td></tr>\n              <tr><td><strong>Turn 2</strong></td><td>2</td><td><code>2 &lt;= 4</code> &rarr; <strong>TRUE</strong></td><td>1</td><td>1 + 2</td><td><strong>3</strong></td><td>3</td></tr>\n              <tr><td><strong>Turn 3</strong></td><td>3</td><td><code>3 &lt;= 4</code> &rarr; <strong>TRUE</strong></td><td>3</td><td>3 + 3</td><td><strong>6</strong></td><td>4</td></tr>\n              <tr><td><strong>Turn 4</strong></td><td>4</td><td><code>4 &lt;= 4</code> &rarr; <strong>TRUE</strong></td><td>6</td><td>6 + 4</td><td><strong>10</strong></td><td>5</td></tr>\n              <tr class=\"highlight-row\"><td><strong>Exit</strong></td><td>5</td><td><code>5 &lt;= 4</code> &rarr; <span style=\"color: #f43f5e;\">FALSE</span></td><td>10</td><td>Loop Ends!</td><td><strong>10</strong></td><td>Prints 10 &rarr; STOP</td></tr>\n            </tbody>\n          </table>\n          <p style=\"font-size: 0.95rem; font-weight: 700; color: var(--accent-emerald); margin-top: 0.5rem;\">Result: Sum of 1 + 2 + 3 + 4 = 10!</p>\n        </div>\n      </div>\n\n      <!-- ================================================================== -->\n      <!-- EXAMPLE 5: SUM OF DIGITS (SLIDES 42-44) -->\n      <!-- ================================================================== -->\n      <div class=\"flowchart-showcase\">\n        <div class=\"flowchart-showcase-header\">\n          <div>\n            <h4><i class=\"fa-solid fa-arrow-rotate-right\"></i> Flowchart Example 5: Sum of Digits of a Number (Slides 42\u201344)</h4>\n            <p style=\"color: var(--text-muted); font-size: 0.85rem; margin-top: 0.25rem;\">Curriculum Algorithm: Repeatedly extract rightmost digit using N % 10 and chop using N / 10.</p>\n          </div>\n          <div class=\"flowchart-badge-group\">\n            <span class=\"fc-type-badge loop\">Digit Extraction</span>\n            <span class=\"fc-type-badge\">Slide 42-44</span>\n          </div>\n        </div>\n\n        <p>How does a computer sum digits of a number like <code>1234</code>? It extracts the rightmost digit with modulo 10 (<code>Rem = N % 10</code>), adds it to an accumulator (<code>Sum = Sum + Rem</code>), and truncates the digit with integer division (<code>N = N / 10</code>). It loops until $N$ becomes 0:</p>\n\n        <!-- SVG Flowchart 5 -->\n        <div class=\"flowchart-svg-card\">\n          <svg viewBox=\"0 0 540 580\" width=\"520\" height=\"560\">\n            <defs>\n              <marker id=\"fc5-arr\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#a1a1aa\" />\n              </marker>\n              <marker id=\"fc5-arr-green\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#10b981\" />\n              </marker>\n              <marker id=\"fc5-arr-red\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#f43f5e\" />\n              </marker>\n              <marker id=\"fc5-arr-cyan\" viewBox=\"0 0 10 10\" refX=\"6\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\">\n                <path d=\"M 0 1 L 10 5 L 0 9 z\" fill=\"#06b6d4\" />\n              </marker>\n            </defs>\n\n            <!-- START -->\n            <rect x=\"170\" y=\"15\" width=\"160\" height=\"38\" rx=\"19\" fill=\"#0f291e\" stroke=\"#10b981\" stroke-width=\"2\"/>\n            <text x=\"250\" y=\"36\" class=\"svg-node-text\" fill=\"#10b981\">START</text>\n\n            <!-- Arrow to READ -->\n            <line x1=\"250\" y1=\"53\" x2=\"250\" y2=\"78\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc5-arr)\"/>\n\n            <!-- READ N -->\n            <polygon points=\"185,78 335,78 305,118 155,118\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"101\" class=\"svg-node-text\" fill=\"#93c5fd\">READ N (e.g. 1234)</text>\n\n            <!-- Arrow to Set Sum = 0 -->\n            <line x1=\"245\" y1=\"118\" x2=\"245\" y2=\"142\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc5-arr)\"/>\n\n            <!-- Sum = 0 -->\n            <rect x=\"170\" y=\"144\" width=\"150\" height=\"38\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"166\" class=\"svg-node-text\" fill=\"#fcd34d\">Set Sum = 0</text>\n\n            <!-- Arrow to Loop Diamond -->\n            <line x1=\"245\" y1=\"182\" x2=\"245\" y2=\"210\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc5-arr)\"/>\n\n            <!-- DIAMOND: Is N != 0? -->\n            <polygon points=\"245,210 345,250 245,290 145,250\" fill=\"#2e1065\" stroke=\"#a855f7\" stroke-width=\"2.5\"/>\n            <text x=\"245\" y=\"253\" class=\"svg-node-text\" fill=\"#e9d5ff\">Is N != 0?</text>\n\n            <!-- YES Branch (Down) -->\n            <line x1=\"245\" y1=\"290\" x2=\"245\" y2=\"320\" stroke=\"#10b981\" stroke-width=\"2\" marker-end=\"url(#fc5-arr-green)\"/>\n            <text x=\"255\" y=\"308\" class=\"svg-label-text true\">YES</text>\n\n            <!-- Rem = N % 10 -->\n            <rect x=\"145\" y=\"322\" width=\"200\" height=\"36\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"343\" class=\"svg-node-text\" fill=\"#fcd34d\" font-size=\"12\">Rem = N % 10 (Extract)</text>\n\n            <!-- Arrow to Sum = Sum + Rem -->\n            <line x1=\"245\" y1=\"358\" x2=\"245\" y2=\"382\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc5-arr)\"/>\n\n            <!-- Sum = Sum + Rem -->\n            <rect x=\"145\" y=\"384\" width=\"200\" height=\"36\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"405\" class=\"svg-node-text\" fill=\"#fcd34d\" font-size=\"12\">Sum = Sum + Rem (Add)</text>\n\n            <!-- Arrow to N = N / 10 -->\n            <line x1=\"245\" y1=\"420\" x2=\"245\" y2=\"444\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc5-arr)\"/>\n\n            <!-- N = N / 10 -->\n            <rect x=\"145\" y=\"446\" width=\"200\" height=\"36\" rx=\"4\" fill=\"#2d1d05\" stroke=\"#f59e0b\" stroke-width=\"2\"/>\n            <text x=\"245\" y=\"467\" class=\"svg-node-text\" fill=\"#fcd34d\" font-size=\"12\">N = N / 10 (Chop Digit)</text>\n\n            <!-- Loopback Arrow -->\n            <path d=\"M 245 482 L 245 515 L 55 515 L 55 198 L 240 198\" fill=\"none\" stroke=\"#06b6d4\" stroke-width=\"2.2\" stroke-dasharray=\"5 3\" marker-end=\"url(#fc5-arr-cyan)\"/>\n            <text x=\"65\" y=\"360\" fill=\"#06b6d4\" font-family=\"var(--font-mono)\" font-size=\"11\" font-weight=\"700\" transform=\"rotate(-90 65 360)\">Loopback: test next N != 0</text>\n\n            <!-- NO Branch (Exit to Right) -->\n            <path d=\"M 345 250 L 440 250 L 440 320\" stroke=\"#f43f5e\" stroke-width=\"2\" marker-end=\"url(#fc5-arr-red)\"/>\n            <text x=\"360\" y=\"240\" class=\"svg-label-text false\">NO (N is 0)</text>\n\n            <!-- PRINT Sum -->\n            <polygon points=\"370,322 510,322 490,365 350,365\" fill=\"#172554\" stroke=\"#3b82f6\" stroke-width=\"2\"/>\n            <text x=\"430\" y=\"346\" class=\"svg-node-text\" fill=\"#93c5fd\" font-size=\"12\">PRINT Sum</text>\n\n            <!-- Arrow to STOP -->\n            <line x1=\"430\" y1=\"365\" x2=\"430\" y2=\"405\" stroke=\"#a1a1aa\" stroke-width=\"2\" marker-end=\"url(#fc5-arr)\"/>\n\n            <!-- STOP -->\n            <rect x=\"350\" y=\"407\" width=\"160\" height=\"38\" rx=\"19\" fill=\"#2b0e14\" stroke=\"#f43f5e\" stroke-width=\"2\"/>\n            <text x=\"430\" y=\"428\" class=\"svg-node-text\" fill=\"#fca5a5\">STOP (END)</text>\n          </svg>\n        </div>\n\n        <div class=\"trace-table-wrap\">\n          <h5>Step-by-Step Execution Trace Table for N = 1234</h5>\n          <table class=\"trace-table\">\n            <thead>\n              <tr><th>Iteration</th><th>Current N</th><th>Rem = N % 10 (Extracted)</th><th>Sum = Sum + Rem</th><th>New N = N / 10 (Remaining)</th></tr>\n            </thead>\n            <tbody>\n              <tr><td><strong>Before Loop</strong></td><td>1234</td><td>-</td><td>0</td><td>1234</td></tr>\n              <tr><td><strong>Turn 1</strong></td><td>1234</td><td>4</td><td>0 + 4 = <strong>4</strong></td><td>123</td></tr>\n              <tr><td><strong>Turn 2</strong></td><td>123</td><td>3</td><td>4 + 3 = <strong>7</strong></td><td>12</td></tr>\n              <tr><td><strong>Turn 3</strong></td><td>12</td><td>2</td><td>7 + 2 = <strong>9</strong></td><td>1</td></tr>\n              <tr><td><strong>Turn 4</strong></td><td>1</td><td>1</td><td>9 + 1 = <strong>10</strong></td><td><strong>0</strong> (Loop Exits!)</td></tr>\n              <tr class=\"highlight-row\"><td><strong>Terminated</strong></td><td>0</td><td>-</td><td><strong>10</strong></td><td>Loop stops; prints 10</td></tr>\n            </tbody>\n          </table>\n          <p style=\"font-size: 0.95rem; font-weight: 700; color: var(--accent-emerald); margin-top: 0.5rem;\">Final Output: Sum = 10 (since 1 + 2 + 3 + 4 = 10)!</p>\n        </div>\n      </div>\n\n      <div class=\"teaching-block\">\n        <h3><i class=\"fa-solid fa-list-check\"></i> Complete Solutions to the 6 Practice Challenges (Slide 45)</h3>\n        <ol>\n          <li><strong>Sum of Multiples of 3 or 5 below 1000:</strong> Loop from 1 to 999. If $(i \\% 3 == 0 \\lor i \\% 5 == 0)$, accumulate $i$ into sum. <strong>Answer = 233,168</strong>.</li>\n          <li><strong>Roots of Quadratic Equation $ax^2 + bx + c = 0$:</strong> Calculate discriminant $D = b^2 - 4ac$. If $D &gt; 0$, roots are $\\frac{-b \\pm \\sqrt{D}}{2a}$. If $D == 0$, equal root is $\\frac{-b}{2a}$. If $D &lt; 0$, complex roots exist.</li>\n          <li><strong>Largest of 3 Numbers ($a, b, c$):</strong> Compare $a &gt; b$. If true, compare $a &gt; c$ to find max ($a$ or $c$). If false, compare $b &gt; c$ to find max ($b$ or $c$).</li>\n          <li><strong>Even or Odd:</strong> Test <code>if (N % 2 == 0)</code> or bitwise <code>if ((N & 1) == 0)</code> &rarr; Even, else Odd.</li>\n          <li><strong>Quotient and Remainder:</strong> In C, <code>A / B</code> performs truncated integer division (quotient), and <code>A % B</code> produces the remainder.</li>\n          <li><strong>Even Numbers between 100 and 200:</strong> Initialize loop variable $i = 102$ and increment with $i = i + 2$ while $i &lt; 200$.</li>\n        </ol>\n      </div>\n",
    "code": {
